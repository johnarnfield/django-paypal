...
payment_profile_created = Signal(providing_args=['nvp_obj', 'params'])

# Sent when a payment is successfully processed.
payment_was_successful = Signal(providing_args=['nvp_obj', 'params'])

# Sent when a payment is flagged.
payment_was_flagged = Signal(providing_args=['nvp_obj', 'params'])

# Sent when user cancels their own recurring profile
recurring_cancel = Signal(providing_args=['nvp_obj', 'params'])

# Sent when user suspends their own profile
recurring_suspend = Signal(providing_args=['nvp_obj', 'params'])

# Send when user reactivates their own profile
recurring_reactivate = Signal(providing_args=['nvp_obj', 'params'])